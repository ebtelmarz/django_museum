...
def fileProcess(fileName):
    ...
    # presentations e events non servono a nulla in questa vista a parte contare il numero di
...
def statistics(request):
    ...
    # qua è ancora tutto da TODO-are ammesso che ci sia qualcosa da todo-are
